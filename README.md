...
| 6 | [hw6](https://github.com/datanalist/ipml_boston_housing/tree/hw6) | [📄](https://github.com/datanalist/ipml_boston_housing/blob/hw6/README.md) | [📖](https://github.com/datanalist/ipml_boston_housing/blob/hw6/DOCUMENTATION_COMPLETION_REPORT.md) | Документация проекта и система генерации отчетов: MkDocs, GitHub Pages ✅ |
...
| **Документация** | MkDocs, Material | Техническая документация и GitHub Pages |
| **Отчеты** | Matplotlib, Jinja2 | Автоматическая генерация отчетов |
...
│   ├── javascripts/     # JavaScript (MathJax)
...
├── .github/
│   └── workflows/
│       └── deploy-docs.yml           # GitHub Actions для документации
├── docker-compose.yml    # Оркестрация контейнеров
├── dvc.yaml              # Конфигурация DVC пайплайна
├── mkdocs.yml            # Конфигурация MkDocs
├── Makefile              # Команды для проекта
...
# Документация
make docs-serve           # Запуск локального сервера документации (http://localhost:8000)
make docs-build           # Сборка статической документации
...
**[→ Открыть полную документацию на GitHub Pages](https://datanalist.github.io/ipml_boston_housing/)**

Полная техническая документация проекта создана с использованием MkDocs и Material theme, включает:

- **Быстрый старт** — установка и первый запуск
- **Руководства** — 12+ подробных гайдов по всем инструментам
- **Развертывание** — локальное и Docker
- **API Reference** — документация кода
- **Примеры использования** — практические use cases
- **Воспроизводимость** — пошаговые инструкции
- **Отчеты об экспериментах** — автоматически генерируемые отчеты с визуализациями
...
- [Работа с документацией](docs/guides/DOCUMENTATION.md)
- [Создание новых гайдов](docs/guides/CREATING-GUIDES.md)

### 🛠️ Локальная работа с документацией
...
Проект включает автоматическую систему генерации отчетов:
...
- **Результат:** Markdown отчеты с графиками в `docs/reports/generated/`

### 🚀 Автоматическая публикация

Документация автоматически публикуется на GitHub Pages через GitHub Actions:

- **Триггер:** Push в main с изменениями в docs/ или mkdocs.yml
- **Время публикации:** ~2-3 минуты
- **Preview:** Автоматический для Pull Requests
