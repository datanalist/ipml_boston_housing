...
|--------|-----------|----------|
| [**Базовое обучение**](basic-training.md) | ⭐ Начальный | Простое обучение одной модели |
| [**Hydra конфигурации**](hydra-config.md) | ⭐⭐ Средний | Управление конфигурациями |
| [**Airflow DAG**](airflow-dag.md) | ⭐⭐ Средний | Оркестрация ML пайплайна |
| [**MLflow трекинг**](mlflow-tracking.md) | ⭐⭐⭐ Продвинутый | Трекинг экспериментов |
...
### [Базовое обучение](basic-training.md)
...
### [Hydra конфигурации](hydra-config.md)
...
### [MLflow трекинг](mlflow-tracking.md)
