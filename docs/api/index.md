...
|--------|----------|--------------|
| **ml_models** | Загрузчик моделей (14 алгоритмов регрессии) | [→](models.md) |
| **tracking** | MLflow трекинг (декораторы, менеджеры) | [→](tracking.md) |
| **config** | Конфигурации и настройки | [→](config.md) |
| **dataset** | Работа с данными | [→](dataset.md) |
| **schemas** | Pydantic схемы валидации | [→](config.md#schemas) |
...
[Подробнее о трекинге →](tracking.md)
...
[Подробнее о конфигурациях →](config.md)

---

## 📖 Детальная документация

### [Модели (ml_models)](models.md)
