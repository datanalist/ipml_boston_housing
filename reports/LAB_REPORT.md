...
1. [Настройка выбранного инструмента](#1-настройка-выбранного-инструмента)
...
1. **Настройка выбранного инструмента**: Установлен и настроен MLflow, развёрнуто облачное хранилище MinIO, создан проект и эксперименты, настроена двухуровневая аутентификация

2. **Проведение экспериментов**: Проведено 15+ экспериментов с различными алгоритмами, настроено логирование метрик, параметров и артефактов, создана система сравнения экспериментов, настроена фильтрация и поиск
...
4. **Отчёт**: Создан данный отчёт в формате Markdown, описана настройка инструмента, добавлены скриншоты результатов, отчёт сохранён в Git репозитории
